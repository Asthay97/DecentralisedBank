...
var WhatTokenSale = artifacts.require("./WhatTokenSale.sol");

contract("WhatTokenSale", function (accounts) {
  var tokenInstance;
    ...
    return WhatToken.deployed()
      ...
      .then(function (balance) {
        assert.equal(
          balance.toNumber(),
          999990,
          "returns all unsold What tokens to admin"
        );
